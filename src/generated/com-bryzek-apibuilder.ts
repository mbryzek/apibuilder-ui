...
export const parameterBounds = {
  getApplications: { limit: { minimum: 1, maximum: 100 }, offset: { minimum: 0 } },
  getChanges: { limit: { minimum: 1, maximum: 100 }, offset: { minimum: 0 } },
  getItems: { limit: { minimum: 1, maximum: 100 }, offset: { minimum: 0 } },
  getMemberships: { limit: { minimum: 1, maximum: 100 }, offset: { minimum: 0 } },
  getMembershipRequests: { limit: { minimum: 1, maximum: 100 }, offset: { minimum: 0 } },
  getOrganizations: { limit: { minimum: 1, maximum: 100 }, offset: { minimum: 0 } },
  getSubscriptions: { limit: { minimum: 1, maximum: 100 }, offset: { minimum: 0 } },
  getVersions: { limit: { minimum: 1, maximum: 100 }, offset: { minimum: 0 } },
  getWatches: { limit: { minimum: 1, maximum: 100 }, offset: { minimum: 0 } }
} as const;
