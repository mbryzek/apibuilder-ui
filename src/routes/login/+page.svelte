...
<div class="page-container">
	<div class="max-w-md mx-auto mt-12">
		<h1 class="text-2xl font-bold text-ab-dark-blue text-center mb-8">Sign in to API Builder</h1>

		{#if githubUrl}
			<a
				href={githubUrl}
				class="w-full flex items-center justify-center gap-2 bg-gray-900 text-white font-semibold px-6 py-3 rounded-lg hover:bg-gray-800 transition-colors"
			>
