  ...
  <div class="max-w-md mx-auto mt-12">
    ...
    {#if success}
      <div class="bg-green-50 border border-green-200 rounded-lg p-4 mb-4">
        <p class="text-green-800 text-sm">If an account exists with that email address, you will receive a password reset link shortly.</p>
      </div>
    {/if}
    ...
    {#if !success}
      ...
      >
        <div class="space-y-4">
          ...
          <button type="submit" disabled={isSubmitting} class="w-full btn-primary">
