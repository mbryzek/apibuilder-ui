...
<div class="page-container">
  {#if session && myOrgs.length > 1}
    ...
    <div class="mb-12">
      <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
        ...
        <a href="/org/create" class="btn-primary mt-4 sm:mt-0 inline-block text-center"> Create Organization </a>
      </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {#each myOrgs as org (org.key)}
          <a href="/{org.key}" class="card hover:shadow-[0_0_17px_-4px_rgba(0,0,0,0.2)] transition-shadow">
            ...
            <span
              class="inline-block mt-2 text-xs font-medium px-2 py-0.5 rounded-full {org.visibility === 'public'
  ...
  {:else if !session}
    ...
    <div class="text-center py-20 sm:py-32">
      <h1 class="text-5xl sm:text-6xl lg:text-7xl font-light text-ab-dark-blue mb-8">API Builder</h1>
      <p class="text-lg sm:text-xl text-ab-gray max-w-2xl mx-auto mb-6 leading-relaxed">The AI Agent's API Toolkit</p>
