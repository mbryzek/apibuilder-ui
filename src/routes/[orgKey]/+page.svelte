...
<div>
  <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-8">
    ...
    {#if data.isMember}
      <a href="/{org.key}/upload" class="btn-primary mt-3 sm:mt-0 inline-block text-center"> Upload API </a>
    {/if}
  </div>
          ...
          {#each apps as app (app.id)}
            <tr class="border-b border-gray-100 hover:bg-ab-light-gray/50 transition-colors">
              ...
              <td class="py-3 hidden sm:table-cell">
                <span
                  class="inline-block text-xs font-medium px-2 py-0.5 rounded-full {app.visibility === 'public'
