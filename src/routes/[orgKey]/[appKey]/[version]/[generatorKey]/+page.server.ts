...
export const load: PageServerLoad = async ({ params, locals }) => {
	...
	const codeResponse = await handleApiCall<Code>(
		() => locals.apiClient.getCodeByGeneratorKey({ orgKey: params.orgKey, applicationKey: params.appKey, version: params.version, generatorKey: params.generatorKey, headers }),
	);
