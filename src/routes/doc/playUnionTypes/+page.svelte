...
<div>
  ...
  <div class="card mb-6">
    ...
    <p class="text-ab-dark-blue mb-4">
      ...
      example, with the discriminator set to <code class="bg-gray-100 px-1 rounded">"type"</code>:
    </p>
  ...
  <div class="card mb-6">
    ...
    <p class="text-ab-dark-blue mb-4">
      When all members are enums, string-serializable primitives (<code class="bg-gray-100 px-1 rounded">string</code>,
      <code class="bg-gray-100 px-1 rounded">uuid</code>,
      <code class="bg-gray-100 px-1 rounded">date-iso8601</code>,
      <code class="bg-gray-100 px-1 rounded">date-time-iso8601</code>), or literal string values, the union is serialized as a plain JSON
  ...
  "version_number": {
    ...
    <pre
      class="bg-gray-50 border border-gray-200 rounded-lg p-4 text-sm overflow-x-auto mb-4">{@html `<code>"2026-03-30T12:00:00.000Z"</code>`}</pre>
