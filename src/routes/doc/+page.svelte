<svelte:head>
  <title>Documentation - API Builder</title>
</svelte:head>
  ...
  <div class="mb-10">
    ...
    <div class="card">
      ...
      <p class="text-ab-dark-blue text-sm">
        See the <a
          href="https://app.apibuilder.io/apicollective/apibuilder-api/latest"
          class="text-ab-blue hover:text-ab-dark-blue underline">API Builder API spec</a
  ...
  <div class="mb-10">
    ...
    <div class="card">
      <p class="text-ab-dark-blue">
        Compile. If it builds, it's correct. The generated interfaces enforce the spec — your implementation either matches or the compiler
