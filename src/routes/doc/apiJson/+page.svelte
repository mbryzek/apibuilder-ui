...
<div>
	...
	<div class="card mb-6" id="name">
		...
		<p class="text-ab-dark-blue mb-4">
			A schema is represented in JSON as a JSON object of type <a href="https://app.apibuilder.io/apicollective/apibuilder-api-json/latest" class="text-ab-blue hover:text-ab-dark-blue underline">api json</a>:
		</p>
  ...
  "attributes": <em><a href="#attribute" class="text-ab-blue hover:text-ab-dark-blue underline">map[object]</a> (optional)</em>,
  ...
  "templates": <em>JSON Object of <a href="#templates" class="text-ab-blue hover:text-ab-dark-blue underline">Templates</a> (optional and experimental)</em>
		...
		<ul class="list-disc pl-6 text-ab-dark-blue mb-4 space-y-2">
			...
			<li><em>attributes</em>: a JSON object (map) defining additional meta data about this service. Attributes are used to add custom extensions to API Builder and are typically used by generators to enable advanced code generation. See <a href="#attribute" class="text-ab-blue hover:text-ab-dark-blue underline">Attribute</a></li>
  ...
  "license": <em>JSON Object of <a href="#license" class="text-ab-blue hover:text-ab-dark-blue underline">License</a> (optional)</em>
		...
		<p class="text-ab-dark-blue mb-2">where:</p>
		<ul class="list-disc pl-6 text-ab-dark-blue mb-4 space-y-2">
			<li><em>contact</em>: specifies contact information for this service. See <a href="#contact" class="text-ab-blue hover:text-ab-dark-blue underline">Contact</a></li>
			<li><em>license</em>: specifies the license under which this service is released. See <a href="#license" class="text-ab-blue hover:text-ab-dark-blue underline">License</a></li>
		</ul>
	</div>
  ...
  "name": {
    ...
    "attributes": <em><a href="#attribute" class="text-ab-blue hover:text-ab-dark-blue underline">map[object]</a> (optional)</em>
		...
		<ul class="list-disc pl-6 text-ab-dark-blue mb-4 space-y-2">
			...
			<li><em>attributes</em>: a JSON object (map) defining additional meta data about this enum for use by generators. See <a href="#attribute" class="text-ab-blue hover:text-ab-dark-blue underline">Attribute</a></li>
		</ul>
	</div>
  ...
  "attributes": <em><a href="#attribute" class="text-ab-blue hover:text-ab-dark-blue underline">map[object]</a> (optional)</em>
		...
		<ul class="list-disc pl-6 text-ab-dark-blue mb-4 space-y-2">
			...
			<li><em>attributes</em>: a JSON object (map) defining additional meta data about this enum value for use by generators. See <a href="#attribute" class="text-ab-blue hover:text-ab-dark-blue underline">Attribute</a></li>
		</ul>
	</div>
  ...
  "name": {
    ...
    "attributes": <em><a href="#attribute" class="text-ab-blue hover:text-ab-dark-blue underline">map[object]</a> (optional)</em>
		...
		<ul class="list-disc pl-6 text-ab-dark-blue mb-4 space-y-2">
			...
			<li><em>attributes</em>: a JSON object (map) defining additional meta data about this model for use by generators. See <a href="#attribute" class="text-ab-blue hover:text-ab-dark-blue underline">Attribute</a></li>
		</ul>
	</div>
  ...
  "annotations": <em>JSON Array of type string where each value indicates the name of a declared annotation (optional)</em>
		...
		<ul class="list-disc pl-6 text-ab-dark-blue mb-4 space-y-2">
			...
			<li><em>description</em>: optional description for what this field provides. Supports <a href="https://help.github.com/articles/github-flavored-markdown/" class="text-ab-blue hover:text-ab-dark-blue underline">GFM</a>.</li>
			...
			<li><em>attributes</em>: a JSON object (map) defining additional meta data about this field for use by generators. See <a href="#attribute" class="text-ab-blue hover:text-ab-dark-blue underline">Attribute</a></li>
		</ul>
  ...
  "name": {
    ...
    "attributes": <em><a href="#attribute" class="text-ab-blue hover:text-ab-dark-blue underline">map[object]</a> (optional)</em>
		...
		<p class="text-ab-dark-blue mb-4">
			More information about interfaces can be found <a href="/doc/interfaces" class="text-ab-blue hover:text-ab-dark-blue underline">here</a>.
		</p>
	</div>
  ...
  "name": {
    ...
    "attributes": <em><a href="#attribute" class="text-ab-blue hover:text-ab-dark-blue underline">map[object]</a> (optional)</em>
		...
		<ul class="list-disc pl-6 text-ab-dark-blue mb-4 space-y-2">
			...
			<li><em>plural</em>: specifies the optional, plural form of the name. By default, we will pluralize the name using a basic set of english heuristics. The plural is used as a default in cases where it is more natural to specify web services. For example, the default path for a resource will be the plural.</li>
			<li><em>discriminator</em>: specifies the name for a type discriminator field which is used in serialization / deserialization to identify the type of object. The name of the discriminator field must be unique across all of the fields across all of the types of this union. See <a href="/doc/playUnionTypes" class="text-ab-blue hover:text-ab-dark-blue underline">Play Union Types</a> for more information and examples.</li>
			...
			<li><em>attributes</em>: a JSON object (map) defining additional meta data about this union for use by generators. See <a href="#attribute" class="text-ab-blue hover:text-ab-dark-blue underline">Attribute</a></li>
		</ul>
	</div>
  ...
  "attributes": <em><a href="#attribute" class="text-ab-blue hover:text-ab-dark-blue underline">map[object]</a> (optional)</em>
		...
		<ul class="list-disc pl-6 text-ab-dark-blue mb-4 space-y-2">
			...
			<li><em>default</em>: If true, indicates that this type should be used as the default when deserializing union types. Sets the default value for the discriminator during deserialization.</li>
			...
			<li><em>attributes</em>: a JSON object (map) defining additional meta data about this union type for use by generators. See <a href="#attribute" class="text-ab-blue hover:text-ab-dark-blue underline">Attribute</a></li>
		</ul>
	</div>
  ...
  "typeName": {
    ...
    "attributes": <em><a href="#attribute" class="text-ab-blue hover:text-ab-dark-blue underline">map[object]</a> (optional)</em>
		...
		<ul class="list-disc pl-6 text-ab-dark-blue mb-4 space-y-2">
			...
			<li><em>attributes</em>: a JSON object (map) defining additional meta data about this resource for use by generators. See <a href="#attribute" class="text-ab-blue hover:text-ab-dark-blue underline">Attribute</a></li>
		</ul>
	</div>
  ...
  "attributes": <em><a href="#attribute" class="text-ab-blue hover:text-ab-dark-blue underline">map[object]</a> (optional)</em>
		...
		<ul class="list-disc pl-6 text-ab-dark-blue mb-4 space-y-2">
			...
			<li><em>description</em>: optional description for what this operation provides. Supports <a href="https://help.github.com/articles/github-flavored-markdown/" class="text-ab-blue hover:text-ab-dark-blue underline">GFM</a>.</li>
			<li><em>body</em>: optional specification for the type of the body of this request. For all operations that support bodies (e.g. POST, PUT, PATCH), allows you to specify the type of the body. See <a href="#body" class="text-ab-blue hover:text-ab-dark-blue underline">Body</a>.</li>
			...
			<li><em>attributes</em>: a JSON object (map) defining additional meta data about this operation for use by generators. See <a href="#attribute" class="text-ab-blue hover:text-ab-dark-blue underline">Attribute</a></li>
		</ul>
	</div>
  ...
  "attributes": <em><a href="#attribute" class="text-ab-blue hover:text-ab-dark-blue underline">map[object]</a> (optional)</em>
		...
		<ul class="list-disc pl-6 text-ab-dark-blue mb-4 space-y-2">
			...
			<li><em>attributes</em>: a JSON object (map) defining additional meta data about this body for use by generators. See <a href="#attribute" class="text-ab-blue hover:text-ab-dark-blue underline">Attribute</a></li>
		</ul>
	</div>
  ...
  "attributes": <em><a href="#attribute" class="text-ab-blue hover:text-ab-dark-blue underline">map[object]</a> (optional)</em>
		...
		<ul class="list-disc pl-6 text-ab-dark-blue mb-4 space-y-2">
			...
			<li><em>description</em>: optional description for what this parameter provides. Supports <a href="https://help.github.com/articles/github-flavored-markdown/" class="text-ab-blue hover:text-ab-dark-blue underline">GFM</a>.</li>
			...
			<li><em>minimum</em>: optional - For a string, refers to the minimum length. For an array, the minimum number of elements in the array. For example, a value of 1 for an array would indicate the array must have at least 1 element.</li>
			<li><em>maximum</em>: optional - For a string, refers to the maximum length. For an array, the maximum number of elements in the array. For example, a value of 1 for an array would indicate the array must have at most 1 element.</li>
			<li><em>attributes</em>: a JSON object (map) defining additional meta data about this parameter for use by generators. See <a href="#attribute" class="text-ab-blue hover:text-ab-dark-blue underline">Attribute</a></li>
		</ul>
	</div>
  ...
  "http_status_code": {
    ...
    "attributes": <em><a href="#attribute" class="text-ab-blue hover:text-ab-dark-blue underline">map[object]</a> (optional)</em>
		...
		<ul class="list-disc pl-6 text-ab-dark-blue mb-4 space-y-2">
			...
			<li><em>attributes</em>: a JSON object (map) defining additional meta data about this response. Attributes are used to add custom extensions to API Builder and are typically used by generators to enable advanced code generation. See <a href="#attribute" class="text-ab-blue hover:text-ab-dark-blue underline">Attribute</a></li>
		</ul>
