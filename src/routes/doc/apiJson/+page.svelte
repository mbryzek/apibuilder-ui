...
<div>
  ...
  <p class="text-ab-dark-blue mb-4 text-lg leading-relaxed">
    ...
    expressive enough for production APIs.
  </p>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 text-sm">
      <div>
        ...
        <ul class="space-y-0.5 ml-6">
          ...
          <li><a href="#namespace" class="text-ab-blue hover:text-ab-dark-blue underline">namespace</a></li>
          <li><a href="#base_url" class="text-ab-blue hover:text-ab-dark-blue underline">base_url</a></li>
          <li><a href="#description" class="text-ab-blue hover:text-ab-dark-blue underline">description</a></li>
        </ul>
      </div>
      <div>
        <h3 class="font-semibold text-ab-blue mb-1 flex items-center gap-1">
        ...
        <ul class="space-y-0.5 ml-6">
          ...
          <li><a href="#field" class="text-ab-blue hover:text-ab-dark-blue underline">Field</a></li>
          <li><a href="#interface" class="text-ab-blue hover:text-ab-dark-blue underline">Interface</a></li>
          <li><a href="#union" class="text-ab-blue hover:text-ab-dark-blue underline">Union</a></li>
          <li><a href="#unionType" class="text-ab-blue hover:text-ab-dark-blue underline">UnionType</a></li>
        </ul>
      </div>
      <div>
        <h3 class="font-semibold text-ab-blue mb-1 flex items-center gap-1">
        ...
        <ul class="space-y-0.5 ml-6">
          ...
          <li><a href="#parameter" class="text-ab-blue hover:text-ab-dark-blue underline">Parameter</a></li>
          <li><a href="#response" class="text-ab-blue hover:text-ab-dark-blue underline">Response</a></li>
        </ul>
      </div>
      <div>
        <h3 class="font-semibold text-ab-blue mb-1 flex items-center gap-1">
  ...
  <div class="card mb-6" id="name">
    ...
    <p class="text-ab-dark-blue mb-4">
      A schema is represented in JSON as a JSON object of type <a
        href="https://app.apibuilder.io/apicollective/apibuilder-api-json/latest"
        class="text-ab-blue hover:text-ab-dark-blue underline">api json</a
      >:
    </p>
  ...
  "annotations": <em>JSON Object of <a href="#annotation" class="text-ab-blue hover:text-ab-dark-blue underline">Annotation</a> (optional)</em>
    ...
    <ul class="list-disc pl-6 text-ab-dark-blue mb-4 space-y-2">
      ...
      <li>
        <em>info</em>: optionally specify additional metadata about this service (e.g. contact info, license). See
        <a href="#info" class="text-ab-blue hover:text-ab-dark-blue underline">Info</a>
      </li>
      <li id="namespace">
        <em>namespace</em>: specifies the namespace for this service. Namespace is primarily used when other services import definitions
        from your service and in the code generators when defining things like package names. If not specified, we will automatically
        generate a namespace based on [organization namespace].[formatted service name].[major version number]. Note that by default API
        Builder includes the major version number in the package name which allows service authors and clients to interact with multiple
        versions of the service where changes have been made in a non backwards compatible way.
      </li>
      <li id="base_url"><em>baseUrl</em>: the base URL where this service is hosted. Must start with http.</li>
      <li id="description">
        <em>description</em>: optional description for what this service provides. Supports
        <a href="https://help.github.com/articles/github-flavored-markdown/" class="text-ab-blue hover:text-ab-dark-blue underline">GFM</a>.
      </li>
      <li>
        <em>imports</em>: JSON array defining any other services whose schema definitions we would like to import into our service. See
        <a href="#import" class="text-ab-blue hover:text-ab-dark-blue underline">Import</a>
      </li>
      <li>
        <em>enums</em>: JSON object defining all of the enums in this API. The key of each object is the enum name. See
        <a href="#enum" class="text-ab-blue hover:text-ab-dark-blue underline">Enum</a>
      </li>
      <li>
        <em>models</em>: JSON object defining all of the models in this API. The key of each object is the model name. See
        <a href="#model" class="text-ab-blue hover:text-ab-dark-blue underline">Model</a>
      </li>
      <li>
        <em>resources</em>: JSON object defining all of the resources in this API. The key of each object is the name of a type that this
        resource represents. The type must be the name of a model or an enum. See
        <a href="#resource" class="text-ab-blue hover:text-ab-dark-blue underline">Resource</a>
      </li>
      <li>
        <em>auth_schemes</em>: JSON array declaring authentication schemes that operations in this service may reference via
        <code>operation.auth</code>. Each scheme is identified by a <code>type</code>. See
        <a href="#auth_scheme" class="text-ab-blue hover:text-ab-dark-blue underline">AuthScheme</a>
        and the <a href="/doc/auth" class="text-ab-blue hover:text-ab-dark-blue underline">Authentication</a> guide.
      </li>
      <li>
        <em>attributes</em>: JSON array defining additional meta data about this service. Attributes are used to add custom extensions to
        API Builder and are typically used by generators to enable advanced code generation. See
        <a href="#attribute" class="text-ab-blue hover:text-ab-dark-blue underline">Attribute</a>
      </li>
      <li>
        <em>annotations</em>: JSON array defining annotations or tags that can be applied to fields regardless of their type. Annotations
        are intended to convey usage hints to consumers of the API. See
        <a href="#annotation" class="text-ab-blue hover:text-ab-dark-blue underline">Annotations</a>
      </li>
    </ul>
  </div>
  ...
  "license": <em>JSON Object of <a href="#license" class="text-ab-blue hover:text-ab-dark-blue underline">License</a> (optional)</em>
    ...
    <ul class="list-disc pl-6 text-ab-dark-blue mb-4 space-y-2">
      ...
      <li>
        <em>license</em>: specifies the license under which this service is released. See
        <a href="#license" class="text-ab-blue hover:text-ab-dark-blue underline">License</a>
      </li>
    </ul>
  </div>
  ...
  "name": {
    ...
    <ul class="list-disc pl-6 text-ab-dark-blue mb-4 space-y-2">
      ...
      <li>
        <em>plural</em>: specifies the optional, plural form of the name. By default, we will pluralize the name using a basic set of
        english heuristics. The plural is used as a default in cases where it is more natural to specify web services. For example, the
        default path for a resource will be the plural.
      </li>
      <li><em>description</em>: optional longer description for this enum.</li>
      <li>
        <em>values</em>: JSON Array of EnumValue objects. Each element defines a valid value and an optional description. See
        <a href="#enumValue" class="text-ab-blue hover:text-ab-dark-blue underline">EnumValue</a>.
      </li>
      <li>
        <em>attributes</em>: JSON array defining additional meta data about this enum for use by generators. See
        <a href="#attribute" class="text-ab-blue hover:text-ab-dark-blue underline">Attribute</a>
      </li>
    </ul>
  </div>
  ...
  "attributes": <em>JSON Array of <a href="#attribute" class="text-ab-blue hover:text-ab-dark-blue underline">Attribute</a> (optional)</em>
    ...
    <ul class="list-disc pl-6 text-ab-dark-blue mb-4 space-y-2">
      ...
      <li>
        <em>description</em>: optional description for what this enum value provides. Supports
        <a href="https://help.github.com/articles/github-flavored-markdown/" class="text-ab-blue hover:text-ab-dark-blue underline">GFM</a>.
      </li>
      <li>
        <em>attributes</em>: JSON array defining additional meta data about this enum value for use by generators. See
        <a href="#attribute" class="text-ab-blue hover:text-ab-dark-blue underline">Attribute</a>
      </li>
    </ul>
  </div>
  ...
  "name": {
    ...
    <ul class="list-disc pl-6 text-ab-dark-blue mb-4 space-y-2">
      ...
      <li>
        <em>description</em>: optional description for what this model provides. Supports
        <a href="https://help.github.com/articles/github-flavored-markdown/" class="text-ab-blue hover:text-ab-dark-blue underline">GFM</a>.
      </li>
      <li>
        <em>fields</em>: indicates that one or more fields is required. See
        <a href="#field" class="text-ab-blue hover:text-ab-dark-blue underline">Field</a>.
      </li>
      <li>
        <em>attributes</em>: JSON array defining additional meta data about this model for use by generators. See
        <a href="#attribute" class="text-ab-blue hover:text-ab-dark-blue underline">Attribute</a>
      </li>
    </ul>
  </div>
  ...
  "annotations": <em>JSON Array of type string where each value indicates the name of a declared annotation (optional)</em>
    ...
    <ul class="list-disc pl-6 text-ab-dark-blue mb-4 space-y-2">
      ...
      <li>
        <em>type</em>: specifies the type of this field. Acceptable values include the name of either an enum, a model, or a (<a
          href="/doc/types"
          class="text-ab-blue hover:text-ab-dark-blue underline">primitive type</a
        >). To specify a List, the type name can be wrapped with "[]". For example, to specify that the type is a collection of strings, use
        "[string]". To specify a Map, the type name can be prefixed with "map[type]". For example, to specify that the type is a Map of
        string to long, use "map[long]". Note that for map, the keys must be strings (per the JSON specification).
      </li>
      <li>
        <em>description</em>: optional description for what this field provides. Supports
        <a href="https://help.github.com/articles/github-flavored-markdown/" class="text-ab-blue hover:text-ab-dark-blue underline">GFM</a>.
      </li>
      <li>
        <em>required</em>: boolean: true|false. By default, all fields are considered required. To make a field optional, set "required" to
        false.
      </li>
      <li>
        <em>default</em>: optional default value. The value must be valid for the type specified for this field. For example, if you specify
        a field named 'limit' with type 'integer', an acceptable default would be 10
      </li>
      <li><em>example</em>: optional - an example value for this field used only in the produced documentation</li>
      <li>
        <em>minimum</em>: optional - For a string, refers to the minimum length. For an array, the minimum number of elements in the array.
        For example, a value of 1 for an array would indicate the array must have at least 1 element.
      </li>
      <li>
        <em>maximum</em>: optional - For a string, refers to the maximum length. For an array, the maximum number of elements in the array.
        For example, a value of 1 for an array would indicate the array must have at most 1 element.
      </li>
      <li>
        <em>attributes</em>: JSON array defining additional meta data about this field for use by generators. See
        <a href="#attribute" class="text-ab-blue hover:text-ab-dark-blue underline">Attribute</a>
      </li>
    </ul>
  ...
  "name": {
    ...
    <ul class="list-disc pl-6 text-ab-dark-blue mb-4 space-y-2">
      <li>
        ...
        an interface and a union of the same name.
      </li>
      <li>
        <em>plural</em>: specifies the optional, plural form of the name. By default, we will pluralize the name using a basic set of
        english heuristics. The plural is used as a default in cases where it is more natural to specify web services. For example, the
    ...
    <p class="text-ab-dark-blue mb-4">
      More information about interfaces can be found <a href="/doc/interfaces" class="text-ab-blue hover:text-ab-dark-blue underline"
        >here</a
      >.
    </p>
  </div>
  ...
  "name": {
    ...
    <ul class="list-disc pl-6 text-ab-dark-blue mb-4 space-y-2">
      <li>
        ...
        interface and a union of the same name, but in this case it is required to list that interface in the interfaces field.
      </li>
      <li>
        <em>fields</em>: Optional JSON Array of 0 or more
        <a href="#field" class="text-ab-blue hover:text-ab-dark-blue underline">Fields</a>. If specified, API Builder will create a model
        named after the type with these specified fields. This is syntactic sugar for creating the model yourself and then referencing here
        as the type.
      </li>
      <li>
        <em>plural</em>: specifies the optional, plural form of the name. By default, we will pluralize the name using a basic set of
      ...
      <li>
        <em>discriminator</em>: specifies the name for a type discriminator field used in serialization / deserialization to identify the
        type of object. For example, a code generator can flatten the JSON representation to: {`{ "discriminator": "xxx", "field1": "yyy" }`}.
        The name of the discriminator field must be unique across all of the fields across all of the types of this union. See
        <a href="/doc/playUnionTypes" class="text-ab-blue hover:text-ab-dark-blue underline">Play Union Types</a> for more information and examples.
      </li>
      <li>
        <em>description</em>: optional description for what this union provides. Supports
        <a href="https://help.github.com/articles/github-flavored-markdown/" class="text-ab-blue hover:text-ab-dark-blue underline">GFM</a>.
      </li>
      <li>
        <em>types</em>: Specifies the individual types that are part of this union type. See
        <a href="#unionType" class="text-ab-blue hover:text-ab-dark-blue underline">UnionType</a>.
      </li>
      <li>
        <em>attributes</em>: JSON array defining additional meta data about this union for use by generators. See
        <a href="#attribute" class="text-ab-blue hover:text-ab-dark-blue underline">Attribute</a>
      </li>
    </ul>
  </div>
  ...
  "attributes": <em>JSON Array of <a href="#attribute" class="text-ab-blue hover:text-ab-dark-blue underline">Attribute</a> (optional)</em>
    ...
    <ul class="list-disc pl-6 text-ab-dark-blue mb-4 space-y-2">
      ...
      <li>
        ...
        used by union types that require a discriminator and sets the default value for that discriminator during deserialization.
      </li>
      <li>
        <em>discriminator_value</em>: The discriminator value defines the string to use in the discriminator field to identify this type. If
        not specified, the discriminator value will default to the name of the type itself.
      </li>
      <li>
        <em>attributes</em>: JSON array defining additional meta data about this union type for use by generators. See
        <a href="#attribute" class="text-ab-blue hover:text-ab-dark-blue underline">Attribute</a>
      </li>
    </ul>
  ...
  "typeName": {
    ...
    <ul class="list-disc pl-6 text-ab-dark-blue mb-4 space-y-2">
      ...
      <li>
        ...
        assumptions of formatting for web (e.g. lower case, dash separated). Path parameters can be specified by prefixing a path element
        with ':'. For example, a path of '/:guid' would imply that all operations for this path will require a parameter named 'guid' of
        type 'string'
      </li>
      <li>
        <em>description</em>: optional description for what this resource provides. Supports
        <a href="https://help.github.com/articles/github-flavored-markdown/" class="text-ab-blue hover:text-ab-dark-blue underline">GFM</a>.
      </li>
      <li>
        <em>operations</em>: one or more operations is required. See
        <a href="#operation" class="text-ab-blue hover:text-ab-dark-blue underline">Operation</a>.
      </li>
      <li>
        <em>auth</em>: optional default <a href="#auth_scheme" class="text-ab-blue hover:text-ab-dark-blue underline">auth_scheme</a>
        <code>type</code>
        applied to every operation on this resource. Per-operation <code>auth</code> overrides this. API Builder materializes the
        inheritance into each operation before emitting the service spec. See the
        <a href="/doc/auth" class="text-ab-blue hover:text-ab-dark-blue underline">Authentication</a> guide.
      </li>
      <li>
        <em>attributes</em>: JSON array defining additional meta data about this resource for use by generators. See
        <a href="#attribute" class="text-ab-blue hover:text-ab-dark-blue underline">Attribute</a>
      </li>
    </ul>
  </div>
  ...
  "attributes": <em>JSON Array of <a href="#attribute" class="text-ab-blue hover:text-ab-dark-blue underline">Attribute</a> (optional)</em>
    ...
    <ul class="list-disc pl-6 text-ab-dark-blue mb-4 space-y-2">
      ...
      <li>
        ...
        specified by prefixing a path element with ':'. For example, a path of '/:guid' would imply that this operation is available at
        /resource_path/:guid. Path parameter types are inferred by looking for a field with that name on the model associated with this
        resource. If not found, the datatype of any path parameter will be string.
      </li>
      <li>
        <em>description</em>: optional description for what this operation provides. Supports
        <a href="https://help.github.com/articles/github-flavored-markdown/" class="text-ab-blue hover:text-ab-dark-blue underline">GFM</a>.
      </li>
      <li>
        <em>body</em>: optional specification for the type of the body of this request. For all operations that support bodies (e.g. POST,
        PUT, PATCH), allows you to specify the type of the body. See
        <a href="#body" class="text-ab-blue hover:text-ab-dark-blue underline">Body</a>.
      </li>
      <li>
        <em>content_type</em>: Content-Type header for the request body. Defaults to <code>application/json</code>. Set explicitly when
        shipping non-JSON payloads (e.g. <code>text/csv</code>, <code>application/octet-stream</code>). When <em>body</em> is
        <code>bytes</code>, you must override this to a non-JSON value — the default <code>application/json</code> is rejected as a validation
        error.
      </li>
      <li>
        <em>parameters</em>: optional JSON Array of the parameters to this method. By default, for GET and DELETE methods, parameters are
        assumed to be in the path or in the query. For other methods, parameters are assumed to be in the path or form body, unless you have
        explicitly specified a body in which case parameters can be provided in the path or the query. See
        <a href="#parameter" class="text-ab-blue hover:text-ab-dark-blue underline">Parameter</a>.
      </li>
      <li>
        <em>responses</em>: optional JSON Object of HTTP Response Code to Response. If not provided, an HTTP NoContent response is assumed.
        Only responses for HTTP status codes that are interesting should be documented. See
        <a href="#response" class="text-ab-blue hover:text-ab-dark-blue underline">Response</a>.
      </li>
      <li>
        <em>auth</em>: optional <a href="#auth_scheme" class="text-ab-blue hover:text-ab-dark-blue underline">auth_scheme</a>
        <code>type</code>
        protecting this operation, or the reserved value <code>none</code> to mark it explicitly public. Overrides any resource-level
        default. See the <a href="/doc/auth" class="text-ab-blue hover:text-ab-dark-blue underline">Authentication</a> guide.
      </li>
      <li>
        <em>attributes</em>: JSON array defining additional meta data about this operation for use by generators. See
        <a href="#attribute" class="text-ab-blue hover:text-ab-dark-blue underline">Attribute</a>
      </li>
    </ul>
  </div>
  ...
  "attributes": <em>JSON Array of <a href="#attribute" class="text-ab-blue hover:text-ab-dark-blue underline">Attribute</a> (optional)</em>
    ...
    <ul class="list-disc pl-6 text-ab-dark-blue mb-4 space-y-2">
      <li>
        ...
        >). To specify a List, the type name can be wrapped with "[]". For example, to specify that the type is a collection of strings, use
        "[string]". To specify a Map, the type name can be prefixed with "map[type]". For example, to specify that the type is a Map of
        string to long, use "map[long]". Note that for map, the keys must be strings (per the JSON specification). Use <code>bytes</code>
        for raw binary payloads (e.g. file uploads) — the body is sent on the wire as opaque bytes; pair with an explicit
        <em>content_type</em>
        on the operation (e.g. <code>text/csv</code>, <code>application/octet-stream</code>).
      </li>
      <li>
        <em>description</em>: optional description for what this body provides. Supports
        <a href="https://help.github.com/articles/github-flavored-markdown/" class="text-ab-blue hover:text-ab-dark-blue underline">GFM</a>.
      </li>
      <li>
        <em>attributes</em>: JSON array defining additional meta data about this body for use by generators. See
        <a href="#attribute" class="text-ab-blue hover:text-ab-dark-blue underline">Attribute</a>
      </li>
    </ul>
  </div>
  ...
  "attributes": <em>JSON Array of <a href="#attribute" class="text-ab-blue hover:text-ab-dark-blue underline">Attribute</a> (optional)</em>
    ...
    <ul class="list-disc pl-6 text-ab-dark-blue mb-4 space-y-2">
      ...
      <li>
        <em>type</em>: specifies the type of this parameter. Acceptable values include the name of either an enum, a model, or a (<a
          href="/doc/types"
          class="text-ab-blue hover:text-ab-dark-blue underline">primitive type</a
        >). To specify a List, the type name can be wrapped with "[]". For example, to specify that the type is a collection of strings, use
        "[string]". To specify a Map, the type name can be prefixed with "map[type]". For example, to specify that the type is a Map of
      ...
      <li>
        <em>location</em>: one of: path, query, form, header. Defines the location of this parameter. Default location varies based on the
        context of the parameter (e.g. if the operation method is a POST, the default will be Form; if a GET, the default will be Query).
      </li>
      <li>
        <em>description</em>: optional description for what this parameter provides. Supports
        <a href="https://help.github.com/articles/github-flavored-markdown/" class="text-ab-blue hover:text-ab-dark-blue underline">GFM</a>.
      </li>
      <li>
        <em>required</em>: boolean: true|false. By default all parameters are considered required. To make a parameter optional, set
        "required" to false.
      </li>
      <li>
        <em>default</em>: optional default value. The value must be valid for the type specified for this parameter. For example, if you
        specify a parameter named 'limit' with type 'integer', an acceptable default would be 10
      </li>
      ...
      <li>
        <em>attributes</em>: JSON array defining additional meta data about this parameter for use by generators. See
        <a href="#attribute" class="text-ab-blue hover:text-ab-dark-blue underline">Attribute</a>
      </li>
    </ul>
  </div>
  ...
  "http_status_code": {
    ...
    <ul class="list-disc pl-6 text-ab-dark-blue mb-4 space-y-2">
      <li>
        ...
        useful to capture a generic error type that would be returned for non documented response codes.
      </li>
      <li>
        <em>type</em>: specifies the type of this response. Acceptable values include the name of either an enum, a model, or a (<a
          href="/doc/types"
          class="text-ab-blue hover:text-ab-dark-blue underline">primitive type</a
        >). To specify a List, the type name can be wrapped with "[]". For example, to specify that the type is a collection of strings, use
        "[string]". To specify a Map, the type name can be prefixed with "map[type]". For example, to specify that the type is a Map of
      ...
      <li>
        <em>description</em>: optional description for what this response provides. Supports
        <a href="https://help.github.com/articles/github-flavored-markdown/" class="text-ab-blue hover:text-ab-dark-blue underline">GFM</a>.
      </li>
      <li>
        <em>attributes</em>: JSON array defining additional meta data about this service. Attributes are used to add custom extensions to
  ...
  "uri": <em>string</em>
    ...
    <ul class="list-disc pl-6 text-ab-dark-blue mb-4 space-y-2">
      <li>
        ...
        <a
          href="https://app.apibuilder.io/apicollective/apibuilder-api/0.16.53/service.json"
          class="text-ab-blue hover:text-ab-dark-blue underline"
          >https://app.apibuilder.io/apicollective/apibuilder-api/0.16.53/service.json</a
        >.
      </li>
    </ul>
  </div>
  ...
  "attributes": <em>JSON Array of <a href="#attribute" class="text-ab-blue hover:text-ab-dark-blue underline">Attribute</a> (optional)</em>
    ...
    <ul class="list-disc pl-6 text-ab-dark-blue mb-4 space-y-2">
      ...
      <li>
        <em>attributes</em>: JSON array of generator-specific metadata. See
        <a href="#attribute" class="text-ab-blue hover:text-ab-dark-blue underline">Attribute</a>.
      </li>
    </ul>
  ...
  <div class="card mb-6" id="annotation">
    ...
    <p class="text-ab-dark-blue mb-4">
      ...
      language support. Generated documentation should include the tag when displaying a field, along with a link to the annotation's
      declaration.
    </p>
  ...
  <div class="mt-12 mb-8 text-center">
    <p class="text-ab-dark-blue mb-4">Ready to build your first API?</p>
