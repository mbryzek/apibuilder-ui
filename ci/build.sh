#!/usr/bin/env bash
#
# What CI runs for apibuilder-ui.
#
...
#
#   dev ci verify --repo mbryzek/apibuilder-ui --sha <head sha> --pr <n> --no-post
#
...
echo "building ${CI_REPO:-apibuilder-ui} @ ${CI_SHA:-working tree} (${CI_EVENT:-local}, clean=${CI_CLEAN_BUILD:-?})"
